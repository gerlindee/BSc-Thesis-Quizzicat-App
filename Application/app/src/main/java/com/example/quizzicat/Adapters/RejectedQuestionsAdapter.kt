...
import com.example.quizzicat.Utils.RejectedAnswerCallBack
    ...
    override fun onBindViewHolder(holder: RejectedQuestionViewHolder, position: Int) {
        ...
        holder.question_topic_icon!!.setOnClickListener {
            PendingDataRetrievalFacade(firebaseFirestore, mainContext)
                .getAnswersForRejectedQuestion(object: RejectedAnswerCallBack {
                    override fun onCallback(value: ArrayList<RejectedQuestionAnswer>) {
